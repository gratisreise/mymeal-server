...
| # | 스킬 | 파일 | 문제 | 수정 방법 |
|---|------|------|------|-----------|
| 1 | verify-<name1> | `src/main/java/.../Service.java:42` | 문제 설명 | 수정 코드 예시 |
| 2 | verify-<name2> | `src/main/java/.../Controller.java:15` | 문제 설명 | 수정 코드 예시 |
```
...
- [1/X] verify-<name1>: `src/main/java/.../Service.java` 수정 완료
- [2/X] verify-<name2>: `src/main/java/.../Controller.java` 수정 완료
...
| # | 스킬 | 파일 | 문제 |
|---|------|------|------|
| 1 | verify-<name> | `src/main/java/.../Service.java:42` | 자동 수정 불가 — 수동 확인 필요 |
