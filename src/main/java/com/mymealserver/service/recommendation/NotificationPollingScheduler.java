...
public class NotificationPollingScheduler {
    ...
    public void pollAndSendNotifications() {
        try {
            ...
            Set<String> dueRecommendationIds = redisSchedulerService.getDueNotifications(currentTimestamp);
            ...
            for (String recommendationIdStr : dueRecommendationIds) {
                try {
                    ...
                    if (recommendation.isNotificationSent()) {
                        ...
                        redisSchedulerService.removeScheduledNotification(recommendationId);
                        continue;
                    }
    ...
    public void logScheduledNotificationCount() {
        long count = redisSchedulerService.getScheduledNotificationCount();
