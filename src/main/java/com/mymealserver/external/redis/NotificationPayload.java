...
public record NotificationPayload(
    ...
    public static NotificationPayload forReactionReminder(
            Long memberId,
            Long mealId
    ) {
        Map<String, String> data = new HashMap<>();
    ...
    public String toJson() {
        try {
            ...
            throw new RuntimeException("Failed to serialize NotificationPayload", e);
        }
    }
    ...
    public static NotificationPayload fromJson(String json) {
        try {
            ...
            throw new RuntimeException("Failed to deserialize NotificationPayload", e);
        }
    }
}
