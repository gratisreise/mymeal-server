...
public record AIAnalysisResponse(
  ...
  public record NutrientsResponse(Double carbohydrates, Double protein, Double fat, Double fiber) {
    private static NutrientsResponse from(MealAnalysis analysis) {
      return new NutrientsResponse(
          analysis.getCarbohydrates(), analysis.getProtein(), analysis.getFat(), 0.0);
    }
  }
}
